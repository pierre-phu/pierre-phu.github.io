...
cover-img: /assets/img/shark.png
thumbnail-img: /assets/img/shark.png
share-img: /assets/img/shark.jpg
tags: [IA, deeplearning, surf, drone]
---

Vous avez sûrement déjà entendu cette statistique assez déroutante "On a plus de chance d'être tué par une noix de coco qui tombe d'un arbre plutôt que par une attaque de requin". Même si cette phrase est vraie à l'échelle mondiale, elle est à prendre avec des pincettes.
...
Vous pouvez voir les résultats de cet algorithme appliqué à une vidéo youtube :
